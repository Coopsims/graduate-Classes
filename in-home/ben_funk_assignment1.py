...
# for "first name unknown". For example for the lists ['Matt', 'Alice'] and [99, 50, 25] should result
...
def paired_list(name_list: list, num_list:list):
...
if __name__ == '__main__':
    ...
    _print(paired_list(names2, nums3))
